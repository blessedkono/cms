...
class RoleController extends Controller
{
    ...
    public function __construct()
    {
        ...
        /*Permissions*/
        $this->middleware('access.routeNeedsPermission:manage_roles_permissions', ['only' => ['create', 'store',  'edit', 'update' ]]);
        $this->middleware('access.routeNeedsPermission:admin_menu', ['only' => ['index',  ]]);
    }
