                                    ...
                                    <ol class="support_document">
                                        @foreach($attachments as $attachment)
                                            ...
                                            <li>
                                                ...
                                                <a href="{!! route('system.document_resource.delete',$attachment->pivot->id) !!}" style="text-decoration: none"><i class="far fa-times-circle" style="color: red">@lang('label.remove')</i></a>
